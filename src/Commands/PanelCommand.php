...
class PanelCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function copyAuthFiles(string $name): void
    {
        ...
        if ($auth) {
            ...
            File::copy(__DIR__.'/../../stubs/resources/js/pages/auth/login.tsx', $filePath = resource_path('js/pages/'.Str::kebab($name).'auth/login.tsx'));
            File::copy(__DIR__.'/../../stubs/resources/js/pages/auth/register.tsx', $filePath = resource_path('js/pages/'.Str::kebab($name).'auth/register.tsx'));
